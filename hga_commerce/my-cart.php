...
//print_r($_SESSION['pid'])=$pdtid;exit;
	?>
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="product-details.php?pid=23">
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "MWK"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "MWK"." ".$row['shippingCharge']; ?>.00</span></td>
