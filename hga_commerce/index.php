...
<html lang="en">
	<head>
	    ...
	    <title class="fa fa-mobile">HGE|Home</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-3 sidebar">
				<!-- ================================== TOP NAVIGATION ================================== -->
	<?php include('includes/side-menu-index.php');?>
<!-- ================================== TOP NAVIGATION : END ================================== -->
			</div><!-- /.sidemenu-holder -->	
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Free Delivery For Purcheses Over MWK. 100000.00</h6>	
				</div>
			</div><!-- .col -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Pictures of Feature Images</h3>
...
?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Feature Product Videos</h3>
								...
								<div class="row product-micro-row">
									<div class="col col-xs-6">
										<video width="180" height="180" controls>
                                            <source src="sqd.mp4" type="video/mp4"                                       
                                        </video>
									</div><!-- /.col -->
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													MWK. <?php echo htmlentities($row['productPrice']);?>
												</span>
...
<div class="cookie-container">
    ...
    <script src="cookies/main.js"></script>
