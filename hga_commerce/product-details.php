...
<html lang="en">
	<head>
	    ...
	    <title>HGE|Product Details</title>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									MWK. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">MWK. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">MWK.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
										...
										<li><a class="fa fa-instagram" aria-hidden="true" href="#"></a></li>
						                <li><a class="fa fa-twitter" href="#"></a></li>
						                <li><a class="fa fa-linkedin" href="#"></a></li>
										<li><a class="fa fa-rss" href="#"></a></li>
										<li><a class="fa fa-reddit" href="#"></a></li>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					MWK.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">MWK.
