...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as proid,ordeMWK.productId as opid,ordeMWK.quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,ordeMWK.paymentMethod as paym,ordeMWK.orderDate as odate,ordeMWK.id as orderid from orders join products on ordeMWK.productId=products.id where ordeMWK.userId='".$_SESSION['id']."' and ordeMWK.paymentMethod is not null");
$cnt=1;
