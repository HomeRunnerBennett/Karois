...
<html lang="en">
	<head>
	    ...
	    <title class="fa fa-mobile">HGE|Workshop</title>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Newly Fixed Benches</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysqli_query($con,"select * from products where subCategory=18");
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					MWK. <?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">MWK.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Newly Fixed Smart Watches</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where subCategory=27");
while ($row=mysqli_fetch_array($ret)) 
{
?>
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					...
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Buy A Similar Product</a></div>
			</div>
			</div>
		</div>
<?php }?>
