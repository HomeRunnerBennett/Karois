...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as c,ordeMWK.productId as opid,ordeMWK.quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,ordeMWK.paymentMethod as paym,ordeMWK.orderDate as odate,ordeMWK.id as oid from orders join products on ordeMWK.productId=products.id where ordeMWK.userId='".$_SESSION['id']."' and ordeMWK.paymentMethod is null");
$cnt=1;
...
?>
				<tr>
					...
					<td><a href="pending-ordeMWK.php?id=<?php echo $row['oid']; ?> ">Delete</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
